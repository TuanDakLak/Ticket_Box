            ...
            <div className="flex items-center gap-3">
              {isAuthenticated ? (
                <>
                  ...
                  <Link href="/dashboard" className="ticketbox-button-primary px-5 py-2.5">
                    Dashboard
                  </Link>
                </>
              ) : (
          ...
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <p className="ticketbox-muted mt-3 max-w-2xl">
                Public catalog — sign in to access your dashboard and account features.
              </p>
            </div>
          </div>
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="mt-4 text-sm leading-6 text-slate-600">
                    Prototype ticket card — login required for booking.
                  </p>
                  {isAuthenticated ? (
                    <button className="ticketbox-button-primary mt-5 w-full">View details</button>
                  ) : (
                    <Link href="/login" className="ticketbox-button-primary mt-5 block w-full text-center">
                      Sign in to book
                    </Link>
                  )}
                </div>
